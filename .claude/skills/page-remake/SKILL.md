...
| Role              | Hex     | Usage             |
| ----------------- | ------- | ----------------- |
| Primary           | #**\_** | [where it's used] |
| Secondary         | #**\_** | [where it's used] |
| Accent            | #**\_** | [where it's used] |
| Background (main) | #**\_** | [where it's used] |
| Background (alt)  | #**\_** | [where it's used] |
| Text (primary)    | #**\_** | [where it's used] |
| Text (secondary)  | #**\_** | [where it's used] |
...
_This analysis guides the remake. Reference it during each section build._
```
